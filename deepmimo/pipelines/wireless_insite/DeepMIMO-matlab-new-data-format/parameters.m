...
params.dataset_folder = 'E:\Shuaifeng-Jiang\GitHub\DeepMIMO1000\scenarios\run_14';
params.scenario = 'study_area_mat';          % The adopted ray tracing scenario [check the available scenarios at https://deepmimo.net/scenarios/]
...
params.active_BS = [1, 2, 3];             % Includes the numbers of the active BSs (values from 1-18 for 'O1')(check the scenario description at https://deepmimo.net/scenarios/ for the BS numbers) 
...
params.active_user_last = 87;        % The last row of the considered user section (check the scenario description for the user row map)
