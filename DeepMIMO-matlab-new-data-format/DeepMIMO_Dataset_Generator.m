...
plot_los_status(DeepMIMO_dataset{3});

% % for saving the images automatically
% plot_los_status(DeepMIMO_dataset{1});
% saveas(gcf, [dataset_params.dataset_folder, '/bs1.fig']);
% saveas(gcf, [dataset_params.dataset_folder, '/bs1.png']);
% close all;
% plot_los_status(DeepMIMO_dataset{2});
% saveas(gcf, [dataset_params.dataset_folder, '/bs2.fig']);
% saveas(gcf, [dataset_params.dataset_folder, '/bs2.png']);
% close all;
% plot_los_status(DeepMIMO_dataset{3});
% saveas(gcf, [dataset_params.dataset_folder, '/bs3.fig']);
% saveas(gcf, [dataset_params.dataset_folder, '/bs3.png']);
% close all;
